...
\begin{align}
    N &= \text{Tr}(\hat N \hat \rho) \\
    &= \sum_n \langle n | N \rho | n \rangle \\\nonumber
    &= \sum_{n,m} \langle n | N | m \rangle \langle m | \rho | n \rangle \\\nonumber
    &= \sum_{n,m} \langle n | N | m \rangle \delta_{nm} f(\varepsilon_n - \mu) \\\nonumber
    &= \sum_n n_n f(\varepsilon_n - \mu)
\end{align}
\end{document}