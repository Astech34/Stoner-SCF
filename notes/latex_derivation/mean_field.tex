...
\begin{gather}
        H = U \sum_i \langle n_{i\uparrow}\rangle \hat n_{i\downarrow} + \langle n_{i\downarrow}\rangle \hat n_{i\uparrow} - \langle n_{i\uparrow}\rangle \langle n_{i\downarrow}\rangle
\end{gather}
...
\end{gather}
with a correction to the energy shift given by
\begin{gather}
